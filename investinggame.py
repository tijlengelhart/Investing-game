...
def round6():
    time.sleep(4)
    print("agent: OHNO! it apears a group of hackers have hacked into our bank account")
    time.sleep(4)
    print("agent: we must fight them of!")
    time.sleep(1)
    print("agent: good luck with this one!")
    time.sleep(1)
    print("agent: you must type the correct order of the following numbers:")
    time.sleep(3)
    print("agent: 4, 6, 5")
    time.sleep(1)
    print("agent: once every period of time you have one guess!")
    time.sleep(1)
    print("agent: so...")
    time.sleep(0.5)
    print("agent: GUESS GOOD!!")
    time.sleep(0.5)
    _hacked1 = True
    while _hacked1 is True:
        time.sleep(sleeptimehacked)
        ...
        print("E*&*(@&#Hjfh98d7f9*(*&98f7d987f9*&98f79df")
        time.sleep(sleeptimehacked)
        hackedguess1 = input("Guess: ")
        if hackedguess1 == str(654):
            _hacked1 = False
